...
public class HttpUtils {
    ...
    public static String submitPostData(String strUrlPath,String params, String encode) {
        ...
        try {            
            ...
            httpURLConnection.setConnectTimeout(5500);     //设置连接超时时间
            ...
            httpURLConnection.setRequestProperty("sign2", sign2);
...
//            return "err: " + e.getMessage().toString();
   ...
   public static String dealResponseResult(InputStream inputStream) {
    ...
    public static void setSign(String s){
       sign = s;
    }
    public static void setSign2(String s){
       sign2 = s;
    }
